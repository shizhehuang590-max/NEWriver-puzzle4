[index (10).html](https://github.com/user-attachments/files/26321975/index.10.html)
<!DOCTYPE html>
<html lang="zh-TW">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        h1 { color: #2980b9; margin: 0 0 5px 0; font-size: 26px; }
        ...
        .panel-header h2 { margin: 0; font-size: 18px; color: #34495e; }
        ...
        .legend-item { display: flex; align-items: center; gap: 6px; font-size: 13px; color: #555; font-weight: 500; }
    ...
    <script>
        ...
        class SearchEngine {
            ...
            render() {
                ...
                // ★ 動態適應演算法：確保樹完全塞入正方形畫布內
                // 動態計算 Y 軸垂直間距 (最多不超過 50px)
                let maxD = Math.max(1, this.stats.maxDepth);
                let ySpacing = Math.min(50, (h - 60) / maxD); 
                ...
                Object.keys(this.levelCounts).forEach(depth => {
                    ...
                    levelNodes.forEach((n, idx) => {
                        ...
                        n.y = depth * ySpacing + 30; // 頂部留 30px 空白
                    });
                });

                // 繪製連線 (使用貝茲曲線創造平滑下垂的樹枝)
